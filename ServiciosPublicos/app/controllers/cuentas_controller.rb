class CuentasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @cuenta.save
        format.html { redirect_to @cuenta, notice: 'Cuenta creada con exito.' }
  ...
  def update
    respond_to do |format|
      if @cuenta.update(cuenta_params)
        format.html { redirect_to @cuenta, notice: 'Cuenta actualizada con exito.' }
  ...
  def destroy
    @cuenta.destroy
    respond_to do |format|
      format.html { redirect_to cuentas_url, notice: 'Cuenta eliminada con exito.' }
  ...
  private
    ...
    def cuenta_params
      params.require(:cuenta).permit(:nombre, :tipo, :codigo, :imputable)
    end
end
