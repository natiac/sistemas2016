...
class ServiciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post servicios_url, params: { servicio: { consumo_minimo: @servicio.consumo_minimo, costo_unitario: @servicio.costo_unitario, id: @servicio.id, unidad_medida: @servicio.unidad_medida } }
    end
  ...
  test "should update servicio" do
    patch servicio_url(@servicio), params: { servicio: { consumo_minimo: @servicio.consumo_minimo, costo_unitario: @servicio.costo_unitario, id: @servicio.id, unidad_medida: @servicio.unidad_medida } }
